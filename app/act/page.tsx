...
export default function ActPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <div className="w-full bg-gradient-to-br from-white to-[#F0F4FA] border border-[#E2E8F0] rounded-2xl mb-0 px-6 md:px-9 py-4 md:py-0 flex flex-col md:flex-row items-center gap-6 shadow-md hover:shadow-lg transition-shadow">
        {/* Left Overall Column – wider (60% on md+) */}
        <div className="w-full md:w-3/5 flex flex-col space-y-2"> {/* Changed space-y-6 to space-y-2 */}
          {/* Search Bar */}
          <div className="flex items-center border border-[#E2E8F0] rounded-full px-4 py-2 w-full bg-white text-sm shadow-sm focus-within:ring-2 focus-within:ring-[#1E4A76]/20 transition">
            <svg
        ...
        {/* Mocks and Questions */}
        <section>
          <div className="w-full py-6 flex flex-col-reverse md:flex-row items-center md:items-start gap-6">
        ...
        <section>
          <div className="w-full py-10 flex flex-col md:flex-row md:items-center gap-6">
            <div className="w-full md:w-1/2 flex justify-center md:justify-start pl-10">
              <Image
                ...
                width={300}
                height={200}
                className="object-contain w-full max-w-sm md:max-w-md drop-shadow-md"
              />
            </div>

            <div className="w-full md:w-1/2 flex flex-col items-right space-y-4">
              <h1 className="text-2xl font-semibold font-sans md:text-right text-center text-[#1E4A76]">Free Video Tutorials</h1>
              <h2 className="text-[#4A5568] font-times text-[17px] md:text-right text-center">
                Free video lessons covering all ACT subjects, strategies, and practice problems to help you master the exam content and boost your confidence.
              </h2>

              <div className="flex flex-wrap gap-3 pt-2 md:items-center md:justify-end justify-center">
                <button className="px-4 py-2 border border-[#1E4A76] text-[#1E4A76] bg-white rounded-md hover:bg-[#1E4A76] hover:text-white transition text-sm font-medium shadow-sm hover:shadow-md">
                  Video Lectures
                </button>
                <button className="px-4 py-2 border border-[#1E4A76] text-[#1E4A76] bg-white rounded-md hover:bg-[#1E4A76] hover:text-white transition text-sm font-medium shadow-sm hover:shadow-md">
                  Create Roadmap
